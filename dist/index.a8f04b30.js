...
"use strict";
function app() {
    _pixels.displayPixels();
}
app();

},{"./pixels":"d9Rvo"}],"d9Rvo":[function(require,module,exports) {
"use strict";
const pixelsBox = document.querySelector(".pixels");
const colorPicker = document.querySelector(".color-picker");
let pixels;
let activeTool = "pedzel";
...
pixelsBox.addEventListener("mousedown", function() {
    ...
    pixelsBox.addEventListener("mouseover", function(event) {
        if (down && event.target.classList.contains("pixel")) event.target.style.background = activeTool === "pedzel" ? activeColor : "#444";
    });
    pixelsBox.addEventListener("mousedown", function(event) {
        if (event.target.classList.contains("pixel")) event.target.style.background = activeTool === "pedzel" ? activeColor : "#444";
    });
});
...
},{}]},["hSiTh","5AKj5"], "5AKj5", "parcelRequire2041")
