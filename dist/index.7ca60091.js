...
})({"1zVBY":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ba43790b7ca60091";
"use strict";
...
},{}],"d9Rvo":[function(require,module,exports) {
"use strict";
...
function displayPixels() {
    for(let i = 0; i < 15; i++)for(let j = 0; j < 14; j++)pixelsBox.insertAdjacentHTML("afterbegin", `<span class="pixel"></span>`);
    pixels = document.querySelectorAll(".pixel");
}
function displayColor(color) {
    paletColors.insertAdjacentHTML("afterbegin", `<span class="color" data-color="${color}" style="background: ${color};"></span>`);
}
...
listOfToolsItems.forEach((element, index)=>{
    element.addEventListener("click", function() {
        ...
        listOfToolsItems[index === 0 ? 1 : 0].innerHTML = index === 0 ? `Gumka` : `Pędzel`;
...
btnDownload.addEventListener("click", function() {
    html2canvas(document.querySelector(".pixels"), {
...
pixelsBox.addEventListener("mousedown", function() {
    ...
    pixelsBox.addEventListener("mouseover", function(event) {
        if (down && event.target.classList.contains("pixel")) event.target.style.background = activeTool === "Pędzel" ? activeColor : "#444";
    });
    pixelsBox.addEventListener("mousedown", function(event) {
        if (event.target.classList.contains("pixel")) event.target.style.background = activeTool === "Pędzel" ? activeColor : "#444";
    });
});
displayPixels();

},{}]},["1zVBY","d9Rvo"], "d9Rvo", "parcelRequire2041")

//# sourceMappingURL=index.7ca60091.js.map
